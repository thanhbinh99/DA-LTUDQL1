...
namespace ThiTracNghiem
{
    public partial class frmGiaoVien : Form
    {
        ...
        void set()
        {
            ...
            qlchCbCapDo.DataBindings.Add("Text", bsCauHoi, "maCD", true, DataSourceUpdateMode.Never, "Null value");
        ...
        void loadCBCauHoi()
        {
            using (var qlttn = new QLTTNDataContext())
            {
                if (qlttn.CapDos.Count() > 0 && qlttn.CauHois.Count() > 0)
                {
                    ...
                    qlchCbCapDo.DisplayMember = "NoiDung";
                    qlchCbCapDo.ValueMember = "maCD";
                    qlchCbCapDo.SelectedValue = qlttn.CapDos.FirstOrDefault().maCD;
                }
                else
                {
        ...
        void loadDGVDapAn()
        {
            using (var qlttn = new QLTTNDataContext())
            {
                if (qlttn.CauHois.Count() > 0)
                {
                    ...
                    qlchDgvDsda.Columns["NoiDung"].Width = 450;
